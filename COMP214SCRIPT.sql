...
(RECORD_EMPLOYEE IN EMPLOYEE%ROWTYPE)
AS
BEGIN
  INSERT INTO EMPLOYEE (EMPLOYEEID, FIRSTNAME, LASTNAME, USERNAME, PASSWORD, ADDRESS, CITY, STATE, ZIP, PHONENUMBER, DEPARTMENTID, COMPANYID) 
  VALUES (SEQUENCE_EMPLOYEEID.NEXTVAL, 
  RECORD_EMPLOYEE.FIRSTNAME, 
  RECORD_EMPLOYEE.LASTNAME, 
  RECORD_EMPLOYEE.PASSWORD, 
  RECORD_EMPLOYEE.ADDRESS, 
  RECORD_EMPLOYEE.CITY, 
  RECORD_EMPLOYEE.STATE, 
  RECORD_EMPLOYEE.ZIP, 
  RECORD_EMPLOYEE.PHONENUMBER, 
  RECORD_EMPLOYEE.DEPARTMENTID, 
  RECORD_EMPLOYEE.COMPANYID);
