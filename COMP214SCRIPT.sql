...
INSERT INTO TAX (TAXID, TOTALINCOME, TOTALTAXESPAID, CONTRIBUTIONS, REFUND, TAXYEAR, EMPLOYEEID) VALUES (SEQUENCE_TAXID.NEXTVAL, 50000, 10000, 2000, 2700, '2015', 1);
INSERT INTO TAX (TAXID, TOTALINCOME, TOTALTAXESPAID, CONTRIBUTIONS, REFUND, TAXYEAR, EMPLOYEEID) VALUES (SEQUENCE_TAXID.NEXTVAL, 100000, 30000, 5000, 3000, '2014', 2);
INSERT INTO TAX (TAXID, TOTALINCOME, TOTALTAXESPAID, CONTRIBUTIONS, REFUND, TAXYEAR, EMPLOYEEID) VALUES (SEQUENCE_TAXID.NEXTVAL, 30000, 2000, 1000, 500, '2013', 3);
INSERT INTO TAX (TAXID, TOTALINCOME, TOTALTAXESPAID, CONTRIBUTIONS, REFUND, TAXYEAR, EMPLOYEEID) VALUES (SEQUENCE_TAXID.NEXTVAL, 24000, 7000, 500, 200, '2012', 4);
INSERT INTO TAX (TAXID, TOTALINCOME, TOTALTAXESPAID, CONTRIBUTIONS, REFUND, TAXYEAR, EMPLOYEEID) VALUES (SEQUENCE_TAXID.NEXTVAL, 30000, 5000, 2000, 1000, '2013', 5);
INSERT INTO TAX (TAXID, TOTALINCOME, TOTALTAXESPAID, CONTRIBUTIONS, REFUND, TAXYEAR, EMPLOYEEID) VALUES (SEQUENCE_TAXID.NEXTVAL, 40000, 6000, 1000, 800, '2014', 6);
INSERT INTO TAX (TAXID, TOTALINCOME, TOTALTAXESPAID, CONTRIBUTIONS, REFUND, TAXYEAR, EMPLOYEEID) VALUES (SEQUENCE_TAXID.NEXTVAL, 30000, 5000, 2000, 1000, '2015', 7);
INSERT INTO TAX (TAXID, TOTALINCOME, TOTALTAXESPAID, CONTRIBUTIONS, REFUND, TAXYEAR, EMPLOYEEID) VALUES (SEQUENCE_TAXID.NEXTVAL, 20000, 1000, 500, 1000, '2015', 8);
INSERT INTO TAX (TAXID, TOTALINCOME, TOTALTAXESPAID, CONTRIBUTIONS, REFUND, TAXYEAR, EMPLOYEEID) VALUES (SEQUENCE_TAXID.NEXTVAL, 50000, 10000, 5000, 2700, '2013', 9);
INSERT INTO TAX (TAXID, TOTALINCOME, TOTALTAXESPAID, CONTRIBUTIONS, REFUND, TAXYEAR, EMPLOYEEID) VALUES (SEQUENCE_TAXID.NEXTVAL, 30000, 3000, 1000, 200, '2014', 1);
...
CREATE INDEX INDEX_EMPLOYEE_NAME
...
CREATE OR REPLACE PROCEDURE SP_INSERT_TAX
  (INCOME IN TAX.TOTALINCOME%TYPE,
   ...
   EMPLOYEEID IN TAX.EMPLOYEEID%TYPE)
AS
  TAXREFUND TAX.REFUND%TYPE;
BEGIN
...
BEGIN
  ...
  INTO TAXYEAR
  FROM DUAL;
  INSERT INTO TAX (TAXID, TOTALINCOME, TOTALTAXESPAID, CONTRIBUTIONS, REFUND, TAXYEAR, EMPLOYEEID) 
  VALUES (SEQUENCE_TAXID.NEXTVAL, INCOME, TAXESPAID, CONTR, REFUND, TAXYEAR, EMPLOYEEID);
END SP_INSERT_TAX;
